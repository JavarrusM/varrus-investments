...
export default function GridListWithHeading() {
  const varrusPropertiesLogoLink =
    "https://firebasestorage.googleapis.com/v0/b/varrus-ee20f.appspot.com/o/home%2Fvarrus-legal-escrow-banner.png?alt=media&token=3c4298b2-868f-4466-aed8-94cfbdd1b2bc";
    ...
    <>
      ...
      <Box p={4}>
        <Stack spacing={4} as={Container} maxW={"3xl"} textAlign={"center"}>
          <Heading fontSize={"3xl"}>Escrow Services</Heading>
          <Text color={"gray.600"} fontSize={"xl"}>
            As a third party service platform we will create an escrow account
            to protect your transactions. Additionally, your escrow account show
            our partners the proof of funds to start their work.
          </Text>
          <Button
            fontWeight={"bold"}
            display="flex"
